  ...
  <div class="row about-main">
    ...
    <div class="col-md-9 about-header">
      ...
      <div class="meta-container">
        {%- assign about_title = site.data.owner[lng].access.sub_title | replace: site.data.conf.main.sample_replace, site.data.lang[lng].constants.sample -%}
        {%- if site.data.owner[lng].access.sub_title %}
          <p class="sub-title">
            {%- if site.data.conf.others.access.sub_title_icon %}<i class="{{ 'fa-fw ' }}{{ site.data.conf.others.access.sub_title_icon }}" aria-hidden="true"></i>{% endif -%}
            &nbsp;{{ about_title }}
          </p>
        {% endif -%}
